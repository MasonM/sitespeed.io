...
module.exports = {
  open(context, options) {
    ...
    this.HTMLBuilder = new HTMLBuilder(context, this.options, this.renderer);
    ...
    if (this.collectDataFrom.indexOf(message.type) > -1) {
      ...
      switch (message.type) {
        ...
        case 'html.pug': {
          ...
          this.renderer.addTemplate(message.data.id, message.data.pug);
        ...
        case 'html.baseDir': {
          this.renderer.addBaseDir(message.data);
          break;
        }
